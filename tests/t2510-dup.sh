...
{
    cat > todo.txt <<EOF
2001-01-01 find a building site a:5 +house
2002-02-02 obtain a bank loan +house w:money k:5
2002-02-03 hire an architect +house w:1 w:2
2002-03-01 build your dream home +house w:3 k:6
2002-03-18 buy new walking shoes
2002-03-18 go jogging
2002-03-19 clean up repair shop
2002-03-20 enroll in swimming lessons
2002-03-21 fix old running shoes
EOF
}
...
5 2002-03-18 buy new walking shoes
...
>>> todo.sh -a -f dup 5 del 9
9 2002-03-21 fix old running shoes => dup of 5
TODO: 9 deleted.
EOF
...
>>> todo.sh -a -f dup 5 del 7 9
7 2002-03-19 clean up repair shop => dup of 5
TODO: 7 deleted.
9 2002-03-21 fix old running shoes => dup of 5
TODO: 9 deleted.
EOF
...
>>> todo.sh -a -f dup 5 trash 9
9 X 2009-02-13 2002-03-21 fix old running shoes => dup of 5
TODO: 9 trashed.
EOF
...
>>> todo.sh -a -f dup 5 trash --hard 9
1 X 2009-02-13 2002-03-21 fix old running shoes => dup of 5
...
6 2002-03-18 go jogging j:fitness
8 2002-03-20 enroll in swimming lessons j:fitness
...
6 2002-03-18 go jogging l:8
TODO: 6 is linked to 8
8 2002-03-20 enroll in swimming lessons l:6
...
6 2002-03-18 go jogging l:8 l:4
TODO: 6 is linked to 8, 4
8 2002-03-20 enroll in swimming lessons l:6 l:4
TODO: 8 is linked to 6, 4
4 2002-03-01 build your dream home +house w:3 k:6 l:6 l:8
